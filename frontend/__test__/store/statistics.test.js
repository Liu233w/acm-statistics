...
jest.mock('~/dynamic/crawlers', () => function () {
  return {
    ...
    crawlers: {
      ...
      cr1: username => Promise.resolve({submissions: 10, solved: 5, solved_list: ['1001', '1002']}),
      // eslint-disable-next-line no-unused-vars
  ...
  describe('startOne', () => {
    ...
    it('能够正常运行', async () => {
      const state = {
        crawlers: {
          cr1: {
            // mock 在文件开头 ({submissions: 10, solved: 5, solved_list: ['1001','1002']}),
            name: 'cr1',
          },
        },
        workers: [
