// <copyright file="Startup.cs" company="西北工业大学ACM开发组">
...
namespace AcmStatisticsAbp.Web.Host.Startup
{
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new Info { Title = "AcmStatisticsAbp API", Version = "v1" });
        ...
        {
            app.Properties["host.AppName"] = "AcmStatisticsAbp";
